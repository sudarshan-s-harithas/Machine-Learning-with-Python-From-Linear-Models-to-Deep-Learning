...
def hinge_loss_full(feature_matrix, labels, theta, theta_0):
    ...
    for k in range(len(feature_matrix)):
            ...
            loss += hinge_loss_single ( feature_matrix[k] , labels[k] , theta , theta_0 )
...
def pegasos_single_step_update(
    ...
    if ( label * ( np.dot(current_theta , feature_vector)  ) <=1 ):
        ...
        current_theta_0 = current_theta_0 + eta * label*L
...
def pegasos(feature_matrix, labels, T, L):
    ...
    for t in range(T):
        ...
        (theta, theta_0)  = pegasos_single_step_update(  feature_matrix[t] , labels[t] ,   L , eta ,theta , theta_0 )
